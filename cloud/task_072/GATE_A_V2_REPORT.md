...
- Old lock failure reproduced; patched Telegram button route keeps `car_wait`: PASS (0.4562s).
...
- Lock fallback: queued in **0.4585s**, then applied after unlock.
...
- Direct path p95/p99: **0.004738s / 0.008697s**.
