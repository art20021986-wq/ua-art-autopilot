...
MANIFEST_SHA256 = 'd800e55813b6edc24322f7021e924dd0052915f07414b42bd02f0a7c234522f5'
SCHEMA = 'UA-ART-COMPLETE17-CODE-HANDOFF-1'
...
def inspect_candidate(candidate):
    ...
    require(manifest['candidate_id'] == 'UA-ART-SPEC-AUTO10-COMPLETE-17-V1'
...
class CodeHandoff:
    ...
    def _backup(self):
        ...
        needed = sum(len(value) for value in self.payload.values()) * 3 + 1024 * 1024
        usage = os.statvfs(self.root)
        require(usage.f_bavail * usage.f_frsize >= needed and
                usage.f_bavail / max(usage.f_blocks, 1) >= 0.20, 'STORAGE_PREFLIGHT')
