...
MANIFEST_SHA256 = '12afce821b784771a2a8a0415cc289f5e713d53aabedf0ed3e2747a8c4d4e136'
SCHEMA = 'UA-ART-COMPLETE17-CODE-HANDOFF-2'
...
def inspect_candidate(candidate):
    ...
    require(manifest['candidate_id'] == 'UA-ART-SPEC-AUTO10-COMPLETE-17-V2'
