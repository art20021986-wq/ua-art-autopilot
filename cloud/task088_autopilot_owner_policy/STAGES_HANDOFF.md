...
2. Render BOTH independent USD prices on vehicle cards AND in catalog. Owner confirmed on 13 September: Ukrainian price INCLUDES delivery to Kyiv and customs clearance in Ukraine; Georgian price INCLUDES delivery to AUTOPAPA market, parking16, and EXCLUDES customs clearance in Georgia. Use the explicit captions in `price_captions.py`. Preserve Ukrainian prices without conversion. Do not infer delivery beyond these destinations, certification, parking/storage fees or duration, or add an all-inclusive/no-extra-charges promise.
