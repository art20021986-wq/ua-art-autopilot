...
Ukraine: delivery to Kyiv and Ukrainian customs included; certification not confirmed.
...
_CAPTIONS = {
    "ru": {
        "ukraine": "Украина — с доставкой до Киева и растаможкой в Украине",
        "georgia": "Грузия — с доставкой до авторынка AUTOPAPA, паркинг №16; без растаможки в Грузии",
    },
    "uk": {
        "ukraine": "Україна — з доставкою до Києва та розмитненням в Україні",
