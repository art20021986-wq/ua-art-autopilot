...
class CatalogParser(HTMLParser):
    ...
    def handle_starttag(self, tag, pairs):
        ...
        if self.current is not None:
            # Explicit vehicle markers remain strict; data-ua also carries
...
def patch_home(source, counts):
    ...
    # Stage A only: keep the existing served JavaScript exactly unchanged.
    return result
