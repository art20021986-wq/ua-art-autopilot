    ...
    with connect_spec(False) as conn:
        ...
        for fact in facts:
            ...
            conn.execute(
                ...
                (
                    uid, key, value, value.casefold(), "AUTO_3SRC", urls[0],
            ...
            conn.execute(
                ...
                (
                    ...
                    "VERIFIED_3SRC", float(fact.get("confidence") or 0.0), 0, 1, utc_now(),
                ),
            )
            written += 1
        conn.commit()
...
if __name__ == "__main__":
    if MAIN_DB.is_file():
        ...
        print("UA110_VIN_SPEC_SERVICE_SELFTEST_PASS")
