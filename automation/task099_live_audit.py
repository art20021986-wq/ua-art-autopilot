...
FUNCTION_NAME = re.compile(
    r"(?:card|car|kartoch|sobrat|html|menu|publish|publik|obnovit|peresobrat|register|handler|master|mashiny|nomer|kadry|proverit|ensure|errors|vin|spec|render|build|open|toggle|field|schema|status|stage|diag|diagnost|container|cta|opis|otpravit|additional|accordion)",
    re.I,
)
