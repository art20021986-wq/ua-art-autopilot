# TASK 040 — UA ART: FULL AUTOMATIC DISPLAY REPLACEMENT «В море» → «На пароме»
...
MAX_ROUNDS: 4
DEPENDS_ON: task_039 must finish or reach a safe terminal state; the workflow queue must preserve task order.
...
- Gate A may write only to a new isolated preview/report/staging namespace dedicated to task_040.
...
Maintain a compact machine-readable progress JSON and owner-facing Russian status under cloud/task_040_ferry_wording/ plus cloud/latest_status.md and cloud/owner_reply.md.
...
Create a self-contained task package under cloud/task_040_ferry_wording/ containing:
